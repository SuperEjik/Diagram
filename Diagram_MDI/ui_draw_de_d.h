...
public:
    ...
    void setupUi(QWidget *Draw_De_D)
    {
        ...
        Save = new QPushButton(Draw_De_D);
        ...
        gridLayout->addWidget(De_D_graph, 1, 0, 1, 2);
    ...
    void retranslateUi(QWidget *Draw_De_D)
    {
        ...
        Save->setText(QCoreApplication::translate("Draw_De_D", "\320\241\320\276\321\205\321\200\320\260\320\275\320\270\321\202\321\214", nullptr));
    } // retranslateUi
